...
;============ INTERRUPCIONES ============
 ...
 btfsc ((INTCON) and 07Fh), 0 ; bandera de cambio en portb
 call int_PORTB
 btfsc ((INTCON) and 07Fh), 2 ; bandera de cambvio en tmr0
 call int_TMR0
...
;============ SUBRUTINAS INTERRUPCIONES ============
 ...
 decf PORTD
 bcf ((INTCON) and 07Fh), 0 ; rst bandera
 return

    int_TMR0: ; subrutina de interrupcion tmr0
 reset_tmr0
 bcf ((INTCON) and 07Fh), 2 ; rst bandera
...
;============ CONFIG INTERRUPCIONES ============
 ...
 bsf INTCON, 3 ;((INTCON) and 07Fh), 3
 bcf INTCON, 0 ;((INTCON) and 07Fh), 0
 bsf INTCON, 5 ;((INTCON) and 07Fh), 5
 return
